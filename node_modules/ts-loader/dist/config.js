...
function getConfigParseResult(compiler, configFile, configFilePath) {
    ...
    if (configFile.config.compilerOptions && typeof configFile.config.compilerOptions.rootDir === 'string') {
        var configuredRootDir = configFile.config.compilerOptions.rootDir;
    ...
    if (typeof compiler.parseJsonConfigFileContent === 'function') {
        ...
        configParseResult = compiler.parseJsonConfigFileContent(configFile.config, compiler.sys, basePath);
    }
    else {
        configParseResult = compiler.parseConfigFile(configFile.config, compiler.sys, basePath);
    }
