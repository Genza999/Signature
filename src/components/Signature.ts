...
export class SignatureCanvas extends Component<SignatureProps, Signaturestate> {
    ...
    //     // this.handlers = [
    //     //  this.canvas.addEventListener("pointermove", this.updateCurve.bind(this)),
    //     //  this.canvas.addEventListener("pointerup", this.endCurve.bind(this))
    //     // ];
    //  }

    //  private updateCurve(e: TouchEvent) {
    //      e.preventDefault();
    //      const context = this.canvas.getContext("2d") as CanvasRenderingContext2D;
    //      this.stopTimeout();
    //      if (this.movedTo) {
    //          this.bezierBuf.push(this.getCoords(e as TouchEvent));
    ...
    //          }
    //      } else {
    //          context.moveTo(this.getCoords(e as TouchEvent).x, this.getCoords(e as TouchEvent).y);
    //          this.movedTo = true;
    //      }
    //  }
    ...
    //      return {
    //          x: c1.x * this.bezier1 + c2.x * this.bezier2 + c3.x * this.bezier3 +
    //          c4.x * this.bezier4,

    //          y: c1.y * this.bezier1 + c2.y * this.bezier2 + c3.y * this.bezier3 +
    //          c4.y * this.bezier4
    //      };
    //  }

    //  private getCoords(e: TouchEvent) {
    //      const position = findDOMNode(this.canvas).getBoundingClientRect();

    //      const pageX = e.pageX;
    //      const pageY = e.pageY;
    //      const x = Math.floor(pageX - position.left);
    //      const y = Math.floor(pageY - position.top);

    //      return { x , y };
    //  }

    //  private endCurve(e: TouchEvent) {
    //      e.preventDefault();
    //      const context = this.canvas.getContext("2d") as CanvasRenderingContext2D;
    //      this.stopTimeout();
